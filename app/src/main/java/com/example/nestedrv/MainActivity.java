...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentList.add(new parent_model(0,null,childList));
        parentList.add(new parent_model(parent_model.TEXT_TYPE,"The Illuminati did not survive their suppression in Bavaria; their further mischief and plottings in the work of Barruel and Robison must be thus considered as the invention of the writers.",null));
        parentList.add(new parent_model(0,null,childList));
        parentList.add(new parent_model(parent_model.TEXT_TYPE,"Conspiracy theorists and writers such as Mark Dice have argued that the Illuminati have survived to this day. Many conspiracy theories propose that world events are being controlled and manipulated by a secret society calling itself the Illuminati. Conspiracy theorists have claimed that many notable people were or are members of the Illuminati. Presidents of the United States are a common target for such claims.",null));
        parentList.add(new parent_model(0,null,childList));
